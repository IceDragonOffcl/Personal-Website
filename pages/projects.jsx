...
export default function Home() {
  ...
  return (
    <>
      <div className="py-20">
        <p className="text-3xl text-white font-semibold text-center">Projelerim</p>
        <p className="text-xl text-white/50 font-normal text-center mb-5">Aktif olarak üzerinde çalıştığım projeler bu alanda.</p>
