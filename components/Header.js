...
const items = [
    { icon: 'fab fa-youtube', link: 'https://www.youtube.com/channel/UCYcjDiCUJSrJer2Ypaa8KDQ' },
    { icon: 'fab fa-twitch', link: 'https://www.twitch.tv/galaxycraftoffcl' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/989163587681517658' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/bursaoyuntr' },
    { icon: 'fab fa-github', link: 'https://github.com/IceDragonOffcl' },
  ]
...
const navItems = [
    ...
    { icon: 'fal fa-phone', active: 'fa fa-phone', label: 'Iletişim', href: '/contact' }
]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">EG</p>
